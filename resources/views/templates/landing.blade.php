...
<head>
	...
	<script type="text/javascript">
		...
		})(window, document, "clarity", "script", "x2ti6hu3se");
	</script>

	<!-- Google tag (gtag.js) -->
	<script async src="https://www.googletagmanager.com/gtag/js?id=AW-18160661655"></script>
	<script>
...
<body>
	<nav class="website">
		<div class="nav-wrapper container">
			...
			<ul class="right">
				...
				<li><button class="btn cta" id="callback-btn" popovertarget="callback-modal">Speak with a QuickBooks Consultant</button></li>
			</ul>
		</div>
	</nav>
	...
	<!-- Default Statcounter code for Quickbook Proadvisors https://quickbookproadvisors.us/ -->
	<script type="text/javascript">
	var sc_project=12948122; 
	var sc_invisible=1; 
	var sc_security="ea64a23c"; 
	</script>
	<script type="text/javascript"
	...
	src="https://c.statcounter.com/12948122/0/ea64a23c/1/"
	...
	<script>
		alert("Your query has been submitted! You will receive a callback shortly.")
